// basic for user
export const HOME = "/practice/questions";
export const LOGIN = "/login";
export const REGISTER = "/register";
// practice
export const PRACTICE_SCOREBOARD = "/practice/scoreboard";
export const PRACTICE_EXERCISES = "/practice/questions";
export const PRACTICE_LOG = "/log";

// exam
export const CONTESTS = "/exams";
export const CONTEST_EXERCISES = "/exams/:examId/questions";
...
export const ADMIN_EXERCISES = "/admin/questions";
export const ADMIN_ADD_EXERCISE = "/admin/questions/add";
export const ADMIN_DETAIL_EXERCISE = "/admin/questions/:questionId/detail";
